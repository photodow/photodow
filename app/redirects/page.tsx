...
export default function Resume() {
        ...
        <div className="jd-redirects cds--grid">
            <div className="cds--row">
                <div className="cds--col jd-redirects__main">
                    <h1 className="jd-redirects__main-title">
                        Redirect Library
                    </h1>
                    <p className="jd-redirects__main-desc">
                        A list of redirect links setup for redirection and
                        sharing.
                    </p>
                </div>
            </div>
            <div className="cds--row">
                <div className="cds--col">
                    <Search
                        className="jd-redirects__search"
                        labelText="Search"
            ...
            <ul className="cds--row jd-redirects__items">
                {links.map(({ _key, description, title, url }) => {
                    return (
                        <li
                            key={_key}
                            className="jd-redirects__item cds--col-sm-4 cds--col-md-4 cds--col-lg-4"
                        >
                            <div className="jd-redirects__item-inner">
                                ...
                                <p className="jd-redirects__desc">
                                    {description}
                                </p>
                                <p className="jd-redirects__redirect-link">
                                    <Link
                                        href={`https://jamesdow.me?r=${_key}`}
                                        target="_blank"
                                    >{`jamesdow.me?r=${_key}`}</Link>
                                </p>
                            </div>
                        </li>
                    );
    ...
    function renderEmptyState() {
        ...
        return (
            <p className="jd-redirects__empty">{`Sorry, we couldn't find any matching results.`}</p>
        );
    }
}
